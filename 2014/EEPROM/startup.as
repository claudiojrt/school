	...
	;This licence will expire on Sun, 01 Nov 2015
	...
	; Compiler options:
	;
	; -oTarefa 1.cof -mTarefa 1.map --summary=default --output=default \
	; Tarefa 1.p1 --chip=16F690 -P --runtime=default --opt=default \
